...
#ifndef __BQ769x2_H__
#define __BQ769x2_H__
...
#define DEV_ADDR  0x10 //769x2 address is 0x10 including R/W bit or 0x8 as 7-bit address
...
#define RX_DATA_ARRAY_SIZE 2
#define RX_32BYTE_ARRAY_SIZE 32
#define CELL_VOLTAGE_ARRAY_SIZE 16
#define TEMP_ARRAY_SIZE 3

#define DEBUG_ENABLE 0

/*Macros*/
#define DFET_OFF_ENABLE HAL_GPIO_WritePin(DFET_OFF_GPIO_Port, DFET_OFF_Pin, 1)
#define DFET_OFF_DISABLE HAL_GPIO_WritePin(DFET_OFF_GPIO_Port, DFET_OFF_Pin, 0)
#define CFET_OFF_ENABLE HAL_GPIO_WritePin(CFET_OFF_GPIO_Port, CFET_OFF_Pin, 1)
#define CFET_OFF_DISABLE HAL_GPIO_WritePin(CFET_OFF_GPIO_Port, CFET_OFF_Pin, 0)

typedef struct
{
uint8_t RX_data [RX_DATA_ARRAY_SIZE]; // used in several functions to store data read from BQ769x2
uint8_t RX_32Byte [RX_32BYTE_ARRAY_SIZE];
...
uint16_t CellVoltage [CELL_VOLTAGE_ARRAY_SIZE];
float Temperature [TEMP_ARRAY_SIZE];
